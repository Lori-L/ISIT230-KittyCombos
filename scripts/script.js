...
let phrase = ["Cat Related Phrase", "Meow-velous Combo!", "Purrrfect Match!", "Endless Paws-ibilities!", "It's Feeline Like a Good One!", "Fun Fur Everyone!", "No Dogs Allowed!"];
...
document.getElementById("btn_start").addEventListener("click", () => { loadCanvas(); document.getElementById("btn_start").style.display = "none"; document.getElementById("btn_redirect-leaderboard").style.display = "none"; changePhrase(); document.getElementById("animation").style.display = "none"; document.getElementById("btn_restart").style.display = "block"; document.getElementById("ui").style.color = "white"; });
...
function changePhrase() {
  document.getElementById("phrase").innerHTML = phrase[Math.floor(Math.random() * phrase.length)];
  if (isUnstable == true) {
    unstable();
  }
}
...
async function loadCanvas() {
  ...
  // Resets the player's turn and score counters.
